...
export function PrivacyPolicyPage(): JSX.Element {
  return (
    <AppPage>
      <Typography>
        <Title level={1}>Privacy Policy for {window.location.hostname.toUpperCase()}</Title>
        ...
        <Paragraph>
          This website will not store personal information such as your name, email address, phone number, etc.
        </Paragraph>

        <Paragraph>
          This website will use https://www.googleapis.com/auth/userinfo.profile to read the name of your Google profile.
        </Paragraph>
