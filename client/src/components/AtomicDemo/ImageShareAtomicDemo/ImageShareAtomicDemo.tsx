...
export function ImageShareAtomicDemo(): JSX.Element {
  const [itemCollection, setItemCollection] =
    ...
    <AppPage pageTitle="Image Share Demo">
      <AutoColumnRow align="middle" gutter={[AutoColumnRowGutterDefault, AutoColumnRowGutterDefault]}>
        <Typography className="max-cell-xs">
          <Paragraph>
            To use this demo service please upload an image file, e.g. .png, .jpg, which is smaller than 8 MiB.
            You cannot delete an image once it is uploaded, however, you can <Mailto to="djared.xeknau@outlook.com" >send me an email</Mailto> to
